...
; the below procedure is to display 32 bit result in ebx why 32 bit & not
16 bit; because 5 digit bcd no ranges between 00000 to 99999 & for
;65535 ans is FFFF
; i.e if u enter the no between 00000-65535 u are getting the answer
between
;0000-FFFF, but u enter i/p as 99999 urans is greater than 16 bit which
is not; fitted in 16 bit register so 32 bit register is taken frresult
...
dec rcx
jnz l77
disp dispbuff+3,5 ;Dispays only lower 5 digits as upper three are
'0'
